...
export default function AdminProductsPage() {
  ...
  if (loading) return <div className="min-h-screen bg-black flex items-center justify-center text-primary">جاري تحميل خزينة الأزياء...</div>;
                    ...
                    <TableCell>
                      <div className="flex flex-col gap-1">
                        ...
                        <span className="text-[8px] text-white/20 uppercase tracking-tighter">
                          {product.variants?.length || 0} خيارات
                        </span>
                      </div>
                    </TableCell>
                    <TableCell>
